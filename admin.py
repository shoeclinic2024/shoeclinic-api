...
# @login_required  <-- Removed for emergency
# @super_admin_required <-- Removed for emergency
    ...
    try:
        ...
        with engine.begin() as conn:
            ...
            if not inspector.has_table('cash_deposit'):
                ...
                """))
                log("Created cash_deposit table")
